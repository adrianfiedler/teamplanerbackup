...
public class MailTexts {
	...
	public static final String UNREGISTER_WEEKLY_TEXT = "<div>Willst du diese Email nicht mehr erhalten, kannst du sie unter Profil verwalten -> Mailverwaltung abstellen. <a href=\""+Constants.LOGIN_URL+"\">"+Constants.LOGIN_URL+"</a></div>";
	public static final String TEAM_QUESTION = "<div>Hast du inhaltliche oder organisatorische Fragen? Dann wende dich an die oben aufgeführten Trainer.</div>";
	
	public static final String UNREGISTER_TRAINER_NOTIF_TEXT = "<div>Du erhältst diese Mail, weil du Termin Benachrichtigungen in deinem Profil aktiviert hast. "
			+ "Du kannst dies jederzeit deaktivieren, indem du dich unter <a href=\""+Constants.LOGIN_URL+"\">"+Constants.LOGIN_URL+"</a> einloggst "
			+ "und in deinen Einstellungen den Haken für Termin Benachrichtigungen rausnimmst.</div>";
	...
	public static final String TUTORIAL_TEXT = "<ul>"
			...
			+ "<br />Hier kannst du zu einem Termin ab- und zusagen. </li>"
