...
public class Constants {
	...
	public static final String SERVICE_URL = PROTOCOL + "jbosswildfly-datacollection.rhcloud.com/rest";
	public static final String ACTIVATION_URL = MAIN_URL + "/activate";
