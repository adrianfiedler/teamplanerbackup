...
insert into User (id, email, facebooktoken, facebookUserId, vorname, name, passwort, admin, aktiviert, aktivierToken, weeklyStatusMail, terminReminderMail, timeZone, user_settings_ref, verein_ref) values (-1, 'BMUNQCMF/zJYU8iUmpBEQ2kChL9jSyiz', NULL, NULL, '3I0kAis4SF4=', '8M5tvTujOTM=', 'xp5qNsuw9sN5s04IoAJyQG86H/vJ9NO5liImuQno1PwsAFEWAtrfgfN5QTg3QAzo9lq3wmV0chmGVI2yARB6nFYtRyCGPNgCPGiMDWVprvFsG59AZHBAk8ZfxkF5gW+4r17Jcjj/Ta5SPRmCr5AtfRzvXd5J2EnvnKNBx98Mcu2ouzv9AQAgnb49gT/nTyiyJL4uxCgA54tgbNejNkbsJg==', true, true, 'token', true, true, 'Europe/Berlin', -1, -1)
insert into User (id, email, facebooktoken, facebookUserId, vorname, name, passwort, admin, aktiviert, aktivierToken, weeklyStatusMail, terminReminderMail, timeZone, user_settings_ref, verein_ref) values (-2, 'DKRxLb8uf06dZnkHTa8i2mE11Kykc3Nn', NULL, NULL, '3EWzbZFGbsM=', '8M5tvTujOTM=', 'xp5qNsuw9sN5s04IoAJyQG86H/vJ9NO5liImuQno1PwsAFEWAtrfgfN5QTg3QAzo9lq3wmV0chmGVI2yARB6nFYtRyCGPNgCPGiMDWVprvFsG59AZHBAk8ZfxkF5gW+4r17Jcjj/Ta5SPRmCr5AtfRzvXd5J2EnvnKNBx98Mcu2ouzv9AQAgnb49gT/nTyiyJL4uxCgA54tgbNejNkbsJg==', true, true, 'token', true, true, 'Europe/Berlin', -2, -1)
...
insert into Termin (id, beschreibung, absageKommentar, datum, name, ort_ref, serie_ref, team_ref, status, maybeAllowed, defaultZusageStatus) values (-1, 'Training', NULL, '2016-06-23 08:00:00', 'Training', -1, NULL, -1, 1, true, 0)
...
insert into Termin (id, beschreibung, absageKommentar, datum, name, ort_ref, serie_ref, team_ref, status, maybeAllowed, defaultZusageStatus) values (-2, 'Spiel 1', NULL, '2016-06-26 09:00:00', 'Spiel 1', -1, NULL, -1, 1, false, 0)
...
insert into Termin (id, beschreibung, absageKommentar, datum, name, ort_ref, serie_ref, team_ref, status, maybeAllowed, defaultZusageStatus) values (-3, 'Spiel 2', NULL, '2016-06-28 10:00:00', 'Spiel 2', -1, NULL, -1, 1, true, 0)
...
insert into Termin (id, beschreibung, absageKommentar, datum, name, ort_ref, serie_ref, team_ref, status, maybeAllowed, defaultZusageStatus) values (-4, 'Spiel Team 2', NULL, '2016-06-29 11:00:00', 'Spiel 1 team 2', -1, NULL, -2, 1, false, 0)
